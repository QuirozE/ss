...
En Julia, el paquete más popular para manipular gráfica es `Graphs.jl`. Está
orientado a la simplicidad y el alto rendimiento, además de ser bastante
modular.
...
visualización. El más popular para visualización en general es `Plots.jl`, que está
exetendido para gráficas por medio del paquete `GraphRecipes.jl`.
"""
...
graphplot(smallgraph(:karate))

# ╔═╡ e72b9b0d-a1de-4187-aa54-dc6f1bf3a500
graphplot(clique_graph(3, 4), method = :circular)

# ╔═╡ 3f1ba432-cd90-435f-b991-7b9088e0452c
graphplot(complete_bipartite_graph(2, 3), method = :tree)
